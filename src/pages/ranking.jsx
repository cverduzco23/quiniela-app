        ...
        ps.forEach(p => {
          ...
          nuevosStats[p.espnId] = {
            ...
            home: {
              ...
              atajadas:       getStat(home?.statistics, 'saves'),
              fuerasJuego:    getStat(home?.statistics, 'offsides'),
              pasesAcertados: getStat(home?.statistics, 'accuratePasses'),
              pasesTotales:   getStat(home?.statistics, 'totalPasses'),
              amarillas:      getStat(home?.statistics, 'yellowCards'),
              rojas:          getStat(home?.statistics, 'redCards'),
              entradas:       getStat(home?.statistics, 'totalTackles'),
              intercepciones: getStat(home?.statistics, 'interceptions'),
              despejes:       getStat(home?.statistics, 'totalClearance'),
            },
            away: {
              ...
              atajadas:       getStat(away?.statistics, 'saves'),
              fuerasJuego:    getStat(away?.statistics, 'offsides'),
              pasesAcertados: getStat(away?.statistics, 'accuratePasses'),
              pasesTotales:   getStat(away?.statistics, 'totalPasses'),
              amarillas:      getStat(away?.statistics, 'yellowCards'),
              rojas:          getStat(away?.statistics, 'redCards'),
              entradas:       getStat(away?.statistics, 'totalTackles'),
              intercepciones: getStat(away?.statistics, 'interceptions'),
              despejes:       getStat(away?.statistics, 'totalClearance'),
            },
          }
